...
function searchPolicies() {
  ...
  accordionItems.forEach((item) => {
    ...
    let buttonMatched =
      button && button.textContent.toLowerCase().includes(input);
...
document
  .getElementById("subControlDropdown")
  .addEventListener("change", function () {
    var subControlId = this.value;
    fetchClauses(
      "linked_control_policy",
      subControlId,
      "linkedControlDropdown"
    );
  });

document
  .getElementById("linkedControlDropdown")
  .addEventListener("change", function () {
    var linkedControlId = this.value;
    fetchClauses(
      "inner_linked_control_policy",
      linkedControlId,
      "innerLinkedDropdown"
    );
  });
