<div class="add-control-form-container">
    ...
    <form class="add-control-main-form" action="" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="sub_control_policy_number" id="sub_control_policy_number">
        </div>

        <div class="mb-3">
            <label for="sub_control_policy_heading" class="form-label">Sub Control | Policy Heading</label>
            <input type="text" class="form-control" name="sub_control_policy_heading" id="sub_control_policy_heading">
        </div>

        <div class="mb-3">
            <label for="html-editor" class="form-label">Policy Details</label>
            <textarea id="html-editor" class="form-control" name="sub_control_policy_det"></textarea>
        </div>
