...
DROP TABLE IF EXISTS `mrb_activities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mrb_activities` (
  `mrb_act_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`mrb_act_id`),
  KEY `mrb_act_deliverable_id` (`mrb_act_deliverable_id`)
...
LOCK TABLES `mrb_activities` WRITE;
/*!40000 ALTER TABLE `mrb_activities` DISABLE KEYS */;
/*!40000 ALTER TABLE `mrb_activities` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-02-20 13:18:10
